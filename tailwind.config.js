...
module.exports = {
  content: ["./examples/**/*.{html,js}", "./src/**/*.{html,js}", "./*.{html,js}"],
  theme: {
    extend: {
      container: {
        padding: {
      ...
      boxShadow: {
       ...
       fontFamily: {
       'display': ['system-ui', '-apple-system', 'Segoe UI', 'Roboto', 'Helvetica', 'Arial', 'sans-serif', 'Apple Color Emoji', 'Segoe UI Emoji'],
