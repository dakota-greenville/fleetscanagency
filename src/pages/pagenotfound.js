 		...
 		<>
			<div className="text-center h-[100vh] w-2/4 mx-auto flex">
				<div className="!z-5 relative w-full rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none p-10 m-auto">
					...
					<Link href="/" className="items-center px-5 py-3 text-sm text-white border rounded-xl border-purple-blue-500 bg-purple-blue-500 hover:bg-purple-blue-700 focus:ring-4 focus:ring-purple-blue-100 transition duration-300">Back to home page</Link>
				</div>
			</div>
		 </>
 	 )
